Motivator
Motivator is a command-line Python project designed to help people cope with their feelings. Note this is not a replacement for a therapist or counselor. Built with a focus on User Wellbeing, Motivation, and making the user laugh. This software delivers a smile to your face or determination when you are feeling down.

Features:
Mood Scanner: The code begins with asking how you feel, and the output you get is based on this. If you are doing good and have no problems it than throws an endless barrage of jokes and riddles at you, but if you are feeling down it gives some motivational quotes to get some determination in you.
